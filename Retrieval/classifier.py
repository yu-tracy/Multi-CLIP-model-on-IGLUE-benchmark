...
class RetrievalXMLCLIP(nn.Module):
    def __init__(self, clipModel, in_dim, out_dim, dropout_prob = 0.1, hid_dim=128):
        super(RetrievalXMLCLIP, self).__init__()
        # embedding_dim = 512
